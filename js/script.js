...
const global = {
    ...
    api: {
      apiKey: '046cbad019d15b8e27aaba530c59eb0e',
...
async function fetchAPIData(endpoint){
    ...
    showSpinner();
    //https://api.themoviedb.org/3/   ENDPOINT    ?api_key=046cbad019d15b8e27aaba530c59eb0e&language=en-US
...
//Display 20 most popular Movies
 async function displayPopularMovies(){
    ...
    //the async/await is here because it has to wait on fetchAPIData
...
function displayPagination(){
  ...
  //Disable Prev button if on fist page
